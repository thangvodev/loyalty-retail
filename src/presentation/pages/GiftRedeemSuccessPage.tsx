...
import { GiftRedeemSuccessPageContent } from "../components/GiftRedeemSuccessPage";

const GiftRedeemSuccessPage = () => {
  return (
    <Page className="page-content relative flex flex-1 flex-col bg-white">
        ...
        title={
          (
            <div className="flex w-[calc(100%-80px)] items-center justify-between pr-[14px]">
              <div className="text-base">Đặt hàng</div>
            </div>
      ...
      <div className="flex flex-1 overflow-auto bg-surface2">
        <GiftRedeemSuccessPageContent />
      </div>
    </Page>
  );
};

export default GiftRedeemSuccessPage;
